...
@register_model("microsoft/adsplus/image/bletchley/v1/position")
class BletchleyForImageRankingPosition(GenericModel):
    replace_keys_in_state_dict = {
        "text_encoder.projection": "text_projection",
        "image_encoder.projection": "image_projection",
    }
    ...
    @classmethod
    @add_default_section_for_init("microsoft/adsplus/image/bletchley/v1/position")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("microsoft/adsplus/image/bletchley/v1/position")
        config_type = config.getoption("config_type", "0.3B")
