...
class TribertForClassification(GenericModel):
    ...
    def from_core_configure(cls, config, **kwargs):
        ...
        vocab_size = config.getoption("vocab_size", 49293)
    ...
    def forward(
        ...
        query_outputs = self.query_encoder(query_input_ids, query_attention_mask, query_token_type_ids, query_position_ids)
        doc_outputs = self.doc_encoder(doc_input_ids, doc_attention_mask, doc_token_type_ids, doc_position_ids)
        ads_outputs = self.ads_encoder(ads_input_ids, ads_attention_mask, ads_token_type_ids, ads_position_ids)
