...
class StableFluxForText2ImageGeneration(GenericStableFluxModel):
    ...
    @classmethod
    @add_default_section_for_init("microsoft/adsplus/diffusers/text2image/stable_flux")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("microsoft/adsplus/diffusers/text2image/stable_flux")
    ...
    @add_default_section_for_function(
        "microsoft/adsplus/diffusers/text2image/stable_flux"
    )
    @autocast(
