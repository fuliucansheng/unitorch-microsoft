...
from typing import Any, DefaultDict, List, Literal, Optional, Tuple, Dict
...
class GoogleSearchEngine(WebSearchEngine):
    def perform_search(
        ...
        """
        raw_results = google_search(query, num_results=num_results, advanced=True)
...
class SearchResponse(GenericResult):
...
class WebSearchTool(GenericTool):
    ...
    name: str = "web_search"
    description: str = _WEBSEARCH_DESCRIPTION
    parameters: dict = {
        "type": "object",
        "properties": {
            "query": {
    ...
    async def _try_all_engines(
        ...
        engine_order = list(self._search_engine.keys())
        failed_engines = []
