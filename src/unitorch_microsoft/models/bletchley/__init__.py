...
pretrained_bletchley_v1_infos = {
    "0.3B": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/bletchley/v1/pytorch_model.0.3B.bin",
    "0.8B": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/bletchley/v1/pytorch_model.0.8B.bin",
    "2.5B": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/bletchley/v1/pytorch_model.2.5B.bin",
}

pretrained_bletchley_v1_extensions_infos = {
    "lora-2.5B-picasso-blurry-image-quality": {
        "text": "#### Prompt: blurry \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v1.lora4.blurry.2409.bin",
    },
    "lora-0.3B-picasso-watermark": {
        "text": "#### Prompt: watermarked, no watermark signature, brand logo \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v1.0.3B.lora4.watermark.2410.bin",
    },
    "lora-0.8B-picasso-backgroundtype": {
        ...
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v1.lora4.bg_type.2501.bin",
    },
    "lora-2.5B-picasso-watermark": {
        "text": "#### Prompt: watermarked, no watermark signature, brand logo \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v1.2.5B.lora4.watermark.2410.bin",
    },
}

pretrained_bletchley_v3_infos = {
    "0.8B": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/bletchley/v3/pytorch_model.base.bin",
    "2.5B": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/bletchley/v3/pytorch_model.large.bin",
}
...
pretrained_bletchley_v3_extensions_infos = {
    "lora-2.5B-flux-image-quality": {
        ...
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v3.lora4.imagequality.flux.2409.bin",
    },
    "lora-2.5B-picasso-blurry-image-quality": {
        "text": "#### Prompt: blurry \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v3.lora4.blurry.2409.bin",
    },
    "lora-2.5B-picasso-bg-blurry-image-quality": {
        "text": "#### Prompt: led lights around the place, out of focus, disgusting, blurry \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v3.lora4.bg.blurry.2412.bin",
    },
    "lora-2.5B-picasso-aesthetics-image-quality": {
        "text": "#### Prompt: draft, disgusting, blurry, disfigured \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v3.lora4.aesthetics.tad66k.2412.bin",
    },
    "lora-0.8B-picasso-watermark": {
        "text": "#### Prompt: watermarked, no watermark signature, brand logo \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v3.0.8B.lora4.watermark.2410.bin",
    },
    "lora-2.5B-picasso-watermark": {
        "text": "#### Prompt: watermarked, no watermark signature, brand logo \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v3.2.5B.lora4.watermark.2410.bin",
    },
    "lora-2.5B-picasso-badcrop": {
        "text": "#### Prompt: bad cropped, cut off, mutilated \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v3.2.5B.lora4.badcrop.2504.bin",
    },
    "lora-2.5B-picasso-whitepad": {
        "text": "#### Prompt: photo collage, white padding \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v3.2.5B.lora4.whitepad.2504.bin",
    },
    "lora-2.5B-query-image-relevance": {
        "text": "#### Prompt: query text \n #### Max Sequence: 36",
        "weight": "https://huggingface.co/buckets/fuliucansheng/unitorchblobfuse/resolve/adsplus/lora/bletchley/pytorch_model.v3.lora4.image.relevance.0.9367.2409.bin",
    },
}
