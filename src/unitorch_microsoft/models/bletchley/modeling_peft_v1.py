...
class BletchleyForImageMatching(GenericModel):
    ...
    def __init__(
        ...
        super().__init__()
        query_config = get_bletchley_image_config(
            query_config_type, gradient_checkpointing
        )
        doc_config = get_bletchley_image_config(doc_config_type, gradient_checkpointing)
...
@register_model("microsoft/model/matching/peft/lora/bletchley/v1/image")
