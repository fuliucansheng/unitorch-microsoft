...
class BletchleyLoraForPretrain(GenericPeftModel, PeftWeightLoaderMixin):
    ...
    @classmethod
    @config_defaults_init("microsoft/model/pretrain/peft/lora/bletchley/v3")
...
class BletchleyLoraForMatching(GenericPeftModel, PeftWeightLoaderMixin):
    ...
    @classmethod
    @config_defaults_init("microsoft/model/matching/peft/lora/bletchley/v3")
    def from_config(cls, config, **kwargs):
...
class BletchleyLoraForMatchingV2(GenericPeftModel, PeftWeightLoaderMixin):
    ...
    @classmethod
    @config_defaults_init("microsoft/model/matching/peft/lora/bletchley/v3/v2")
    def from_config(cls, config, **kwargs):
