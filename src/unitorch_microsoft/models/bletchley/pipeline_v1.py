...
class BletchleyForMatchingPipeline(_BletchleyForMatching):
    ...
    @classmethod
    @config_defaults_init("microsoft/models/bletchley/pipeline/v1/matching")
    def from_config(
        cls,
        config,
    ...
    @torch.no_grad()
    @config_defaults_method("microsoft/models/bletchley/pipeline/v1/matching")
    def __call__(
        self,
        text: str,
        image: Image.Image,
...
class BletchleyForMatchingV2Pipeline(_BletchleyForMatchingV2):
    ...
    @classmethod
    @config_defaults_init("microsoft/models/bletchley/pipeline/v1/matching/v2")
    def from_config(
        cls,
        config,
        config_type: Optional[str] = None,
