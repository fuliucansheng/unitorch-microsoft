...
class BletchleyProcessor:
    def __init__(
        ...
        vocab_path = cached_path("https://huggingface.co/FacebookAI/xlm-roberta-large/resolve/main/sentencepiece.bpe.model")
    ...
    @classmethod
    @add_default_section_for_init("microsoft/process/bletchley/v1")
    ...
    @register_process("microsoft/process/bletchley/v1/classification")
    def _classification(
        self,
        text: str,
    ...
    @register_process("microsoft/process/bletchley/v1/text_classification")
    ...
    @register_process("microsoft/process/bletchley/v1/image_classification")
