...
class ControlNetForImage2ImageGeneration(GenericStableModel):
    ...
    @classmethod
    @add_default_section_for_init("microsoft/model/diffusers/image2image/controlnet")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("microsoft/model/diffusers/image2image/controlnet")
