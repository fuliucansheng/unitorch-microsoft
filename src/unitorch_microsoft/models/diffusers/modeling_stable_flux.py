...
@register_model("microsoft/model/diffusers/text2image/stable_flux")
class StableFluxForText2ImageGeneration(GenericStableFluxModel):
    ...
    def forward(
        ...
        sigmas = torch.sigmoid(torch.randn((batch,), device=self.device)).unsqueeze(1)
        ...
        latent_model_input = _pack_latents(
            ...
            num_channels_latents=noise_latents.shape[1],
