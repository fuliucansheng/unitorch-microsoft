...
class DinoV2Processor(_DinoV2Processor):
    ...
    def from_core_configure(cls, config, **kwargs):
        ...
        """
        config.set_default_section("microsoft/process/dinov2")
    ...
    @register_process("microsoft/process/dinov2/image_classification")
    def _image_classification(
        ...
        inputs = {"pixel_values": outputs.pixel_values}
