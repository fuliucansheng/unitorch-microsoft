...
from unitorch_microsoft.models.bletchley.modeling_v3 import BletchleyImageEncoder
from unitorch_microsoft.models.llava import (
    pretrained_llava_infos,
    pretrained_llava_extensions_infos,
)


@register_model("microsoft/model/classification/peft/lora/llava/mistral_bletchley_v3")
class LlavaMistralBlethchleyV3LoraForClassification(GenericPeftModel):
    ...
    def __init__(
        ...
        self.vision_tower = BletchleyImageEncoder(
            vision_config_type,
            add_projection_layer=False,
        )
        self.config.vision_config.hidden_size = self.vision_tower.hidden_size
...
class LlavaMistralBlethchleyV3LoraForGeneration(GenericPeftModel):
    prefix_keys_in_state_dict = {
        "^language_model.": "peft_model.base_model.",
    }
    replace_keys_in_state_dict = {
