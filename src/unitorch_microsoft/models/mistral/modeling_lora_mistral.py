...
@register_model(
    "microsoft/model/generation/peft/lora/mistral", generation_model_decorator
)
class MistralLoraForGeneration(GenericPeftModel):
    ...
    @classmethod
    @add_default_section_for_init("microsoft/model/generation/peft/lora/mistral")
    def from_core_configure(cls, config, **kwargs):
        ...
        """
        config.set_default_section("microsoft/model/generation/peft/lora/mistral")
    ...
    @add_default_section_for_function("microsoft/model/generation/peft/lora/mistral")
    @torch.no_grad()
    def generate(
        self,
        input_ids: torch.Tensor,
