...
@register_model("microsoft/model/classification/mmdnn/bletchley/v3/intl")
...
@register_model("microsoft/model/classification/mmdnn/bletchley/v3/v2/intl")
class MMDNNBletchleyForClassificationV2(GenericModel):
    ...
    @classmethod
    @add_default_section_for_init(
        "microsoft/model/classification/mmdnn/bletchley/v3/v2/intl"
    )
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section(
            "microsoft/model/classification/mmdnn/bletchley/v3/v2/intl"
