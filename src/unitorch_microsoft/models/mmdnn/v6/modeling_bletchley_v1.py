...
@register_model("microsoft/model/classification/mmdnn/v6/bletchley/v1")
...
@register_model("microsoft/model/classification/mmdnn/v6/bletchley/v1/noids")
class MMDNNBletchleyForClassificationNoIds(GenericModel):
    ...
    @classmethod
    @add_default_section_for_init(
        "microsoft/model/classification/mmdnn/v6/bletchley/v1/noids"
    )
    def from_core_configure(cls, config, **kwargs):
...
class MMDNNBletchleyTextForClassification(GenericModel):
    ...
    @classmethod
    @add_default_section_for_init(
        "microsoft/model/classification/mmdnn/v6/bletchley/v1/text"
    )
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section(
            "microsoft/model/classification/mmdnn/v6/bletchley/v1/text"
...
class MMDNNBletchleyTextForClassificationNoIds(GenericModel):
    ...
    @classmethod
    @add_default_section_for_init(
        "microsoft/model/classification/mmdnn/v6/bletchley/v1/text/noids"
    )
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section(
            "microsoft/model/classification/mmdnn/v6/bletchley/v1/text/noids"
...
class MMDNNBletchleyForClassificationV2(GenericModel):
    ...
    @classmethod
    @add_default_section_for_init(
        "microsoft/model/classification/mmdnn/v6/bletchley/v1/v2"
    )
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section(
            "microsoft/model/classification/mmdnn/v6/bletchley/v1/v2"
