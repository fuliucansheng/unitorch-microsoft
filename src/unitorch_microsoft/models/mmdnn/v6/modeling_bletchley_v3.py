...
@register_model("microsoft/model/classification/mmdnn/v6/bletchley/v3")
class MMDNNBletchleyForClassification(GenericModel):
    ...
    @classmethod
    @add_default_section_for_init("microsoft/model/classification/mmdnn/v6/bletchley/v3")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("microsoft/model/classification/mmdnn/v6/bletchley/v3")
...
@register_model("microsoft/model/classification/mmdnn/v6/bletchley/v3/noids")
class MMDNNBletchleyForClassificationNoIds(GenericModel):
    def __init__(
        self,
        query_config_type: str,
        offer_config_type: str,
    ...
    @classmethod
    @add_default_section_for_init("microsoft/model/classification/mmdnn/v6/bletchley/v3/noids")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("microsoft/model/classification/mmdnn/v6/bletchley/v3/noids")
        query_config_type = config.getoption("query_config_type", "0.8B")
        offer_config_type = config.getoption("offer_config_type", "0.8B")
        projection_dim = config.getoption("projection_dim", 288)
        output_hidden_dim = config.getoption("output_hidden_dim", 64)
...
@register_model("microsoft/model/classification/mmdnn/v6/bletchley/v3/text")
class MMDNNBletchleyTextForClassification(GenericModel):
    ...
    @classmethod
    @add_default_section_for_init(
        "microsoft/model/classification/mmdnn/v6/bletchley/v3/text"
    )
    def from_core_configure(cls, config, **kwargs):
...
@register_model("microsoft/model/classification/mmdnn/v6/bletchley/v3/text/reslayer")
class MMDNNBletchleyReslayerTextForClassification(GenericModel):
    def __init__(
        self,
        query_config_type: str,
        offer_config_type: str,
    ...
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section(
            "microsoft/model/classification/mmdnn/v6/bletchley/v3/text/reslayer"
        )
        query_config_type = config.getoption("query_config_type", "0.3B")
        offer_config_type = config.getoption("offer_config_type", "0.3B")
        projection_dim = config.getoption("projection_dim", 288)
...
@register_model("microsoft/model/classification/mmdnn/v6/bletchley/v3/text/noids")
class MMDNNBletchleyTextForClassificationNoIds(GenericModel):
    ...
    @classmethod
    @add_default_section_for_init(
        "microsoft/model/classification/mmdnn/v6/bletchley/v3/text/noids"
    )
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section(
            "microsoft/model/classification/mmdnn/v6/bletchley/v3/text/noids"
...
@register_model("microsoft/model/classification/mmdnn/v6/bletchley/v3/v2")
class MMDNNBletchleyForClassificationV2(GenericModel):
    ...
    @classmethod
    @add_default_section_for_init(
        "microsoft/model/classification/mmdnn/v6/bletchley/v3/v2"
    )
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section(
            "microsoft/model/classification/mmdnn/v6/bletchley/v3/v2"
