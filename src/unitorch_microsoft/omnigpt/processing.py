...
# fix qwen processor with replace
...
from unitorch.models.qwen.processing import QWenProcessor


@replace(QWenProcessor)
class QWenProcessorV2(HfLlmProcessor):
    def __init__(
        self,
        tokenizer_file: str,
...
class OmniGPTProcessor:
    ...
    @classmethod
    @add_default_section_for_init("microsoft/omnigpt/process")
