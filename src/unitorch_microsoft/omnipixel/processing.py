...
class OmnipixelProcessor:
    ...
    @register_process("microsoft/omnipixel/process/random_mask")
    def _random_mask(
        self,
    ...
    @register_process("microsoft/omnipixel/process/random_lama_mask")
    ...
    @register_process("microsoft/omnipixel/process/random_object_mask")
    ...
    @register_process("microsoft/omnipixel/process/outpainting/random_mask")
