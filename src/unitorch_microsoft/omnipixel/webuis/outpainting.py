...
from unitorch.cli.pipelines.stable_flux.inpainting import StableFluxForImageInpaintingPipeline
...
@register_webui("microsoft/omnipixel/webui/outpainting")
class StableFluxImageOutpaintingWebUI(SimpleWebUI):
    ...
    def __init__(self, config: CoreConfigureParser):
        ...
        super().__init__(config, iname="Outpainting", iface=iface)
    ...
    def start(self, pretrained_name, **kwargs):
        ...
        self._pipe = StableFluxForImageInpaintingPipeline.from_core_configure(
            self._config,
