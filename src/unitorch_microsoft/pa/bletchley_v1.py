...
@register_model("microsoft/pa/pretrain/bletchley/v1")
...
@register_model("microsoft/pa/pretrain/bletchley/v1/v2")
...
@register_model("microsoft/pa/pretrain/bletchley/v1/v2/text")
