...
class BletchleyForPretrain(GenericModel):
    ...
    @classmethod
    @config_defaults_init("microsoft/pa/pretrain/bletchley/v3")
...
class BletchleyForPretrainV2(GenericModel):
    ...
    @classmethod
    @config_defaults_init("microsoft/pa/pretrain/bletchley/v3/v2")
    def from_config(cls, config, **kwargs):
...
class BletchleyTextForPretrainV2(GenericModel):
    ...
    @classmethod
    @config_defaults_init("microsoft/pa/pretrain/bletchley/v3/v2/text")
    def from_config(cls, config, **kwargs):
