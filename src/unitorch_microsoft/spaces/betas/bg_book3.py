...
class BookBG3WebUI(SimpleWebUI):
    _title = "Book Product Enhancement 3"
    ...
    def generate(self, image, ratio):
        prompt0 = """
Can you create the background image for this book if I want to place this book on the generated background as a display ad banner? Follow the guidelines below and avoid copyright policy violation if needed. 
