...
class ExpandBGWebUI(SimpleWebUI):
    ...
    _description = "This is a demo for expanding the background of images using FLUX. You can input an image and a prompt, and the model will generate a new image with the specified background."
