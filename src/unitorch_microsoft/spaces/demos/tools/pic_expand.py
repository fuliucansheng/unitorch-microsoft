...
class PicExpandWebUI(SimpleWebUI):
    def __init__(self, config: CoreConfigureParser):
        ...
        header = create_element(
            "markdown",
            label=f"# <div style='margin-top:10px'>🛠️ Image Expand</div>",
            interactive=False,
        )
        ...
        input_ratio = create_element(
            "slider", "Ratio", default=2.0, min_value=0.2, max_value=5.0, step=0.1
        )
        ...
        iface._title = "Image Expand"
        iface._description = "This is a demo for image expand."
        ...
        super().__init__(config, iname="Image Expand", iface=iface)
