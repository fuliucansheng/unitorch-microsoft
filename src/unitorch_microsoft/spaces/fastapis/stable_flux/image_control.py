...
class FluxControlPipelineV2(FluxControlPipeline):
    def prepare_latents(
        self,
        batch_size,
    ...
    def __call__(
        ...
        latent_image: Optional[torch.FloatTensor] = None,
...
class StableFluxForImageControlFastAPIPipeline(GenericStableFluxModel):
    def __init__(
        self,
        config_path: str,
        ...
        self.pipeline = FluxControlPipelineV2(
            vae=self.vae,
    ...
    def from_core_configure(
        ...
        **kwargs,
        ...
        config.set_default_section(
            "microsoft/spaces/fastapi/pipeline/stable_flux/image_control"
        )
        pretrained_name = pretrained_name or config.getoption(
            "pretrained_name", "stable-flux-dev-redux-canny"
        )
...
@register_fastapi("microsoft/spaces/fastapi/stable_flux/image_control")
class StableFluxImageControlFastAPI(GenericFastAPI):
    def __init__(self, config: CoreConfigureParser):
        self.config = config
        config.set_default_section(
            f"microsoft/spaces/fastapi/stable_flux/image_control"
        )
        router = config.getoption(
            "router", "/microsoft/spaces/fastapi/stable_flux/image_control"
        )
        self._pipe = None
    ...
    def start(self):
        ...
        self._pipe = StableFluxForImageControlFastAPIPipeline.from_core_configure(
            self.config,
        )
