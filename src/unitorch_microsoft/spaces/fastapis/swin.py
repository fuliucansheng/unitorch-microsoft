...
@register_fastapi("microsoft/spaces/fastapi/swin/googlecate")
class GoogleCateFastAPI(GenericFastAPI):
    def __init__(self, config: CoreConfigureParser):
        self._config = config
        config.set_default_section(f"microsoft/spaces/fastapi/swin/googlecate")
        self._model = None
        ...
        router = config.getoption("router", "/microsoft/spaces/fastapi/swin/googlecate")
    ...
    async def generate(
        ...
        async with self._lock:
            ...
            results = [
                {
                    "cate": self._cates.get(idx, "unknown"),
                    "score": results[idx],
                }
