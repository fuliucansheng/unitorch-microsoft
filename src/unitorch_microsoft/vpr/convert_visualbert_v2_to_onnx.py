...
processor = VisualBertProcessor(vocab_path=cached_path("https://huggingface.co/bert-base-uncased/resolve/main/vocab.txt"), max_seq_length=36)
tokens = processor._classification("clothing shoes jewelry women clothing coats jackets vests")
...
# %%
query = torch.tensor([101, 5929, 6007, 11912, 2308, 5929, 15695, 17764, 17447, 2015, 102]).unsqueeze(-1)
...
quantization.quantize_dynamic("/disk/lixin/ckpt/visualbert/visualbertv2.onnx", "/disk/lixin/ckpt/visualbert/visualbertv2_int8.onnx")
