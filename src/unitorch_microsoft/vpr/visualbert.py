...
@register_model("microsoft/vpr/pretrain/visualbert/cl")
class VisualBertForPretrain(GenericModel):
    ...
    @classmethod
    @add_default_section_for_init("microsoft/vpr/pretrain/visualbert/cl")
    def from_core_configure(cls, config, **kwargs):
        config.set_default_section("microsoft/vpr/pretrain/visualbert/cl")
